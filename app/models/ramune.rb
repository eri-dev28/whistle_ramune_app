class Ramune < ApplicationRecord
  ...
  # 各項目に0以上100以下の整数で入力できる制約を設定する
  with_options numericality: { only_integer: true, greater_than_or_equal_to: 0, less_than_or_equal_to: 100, message: "0以上100以下の整数で入力してください" } do
    validates :ramune_normal_girl
    validates :ramune_normal_boy
    validates :ramune_melon_girl
    validates :ramune_melon_boy
